          ...
          <?php
              if(isset($_POST['submit'])){
                ...
                if (empty($nama)){
                  ...
                  $simpan=mysqli_query($koneksi,"UPDATE admin SET nama='$nama',username='$username',password='$password' WHERE id_admin='$id_admin'");
                if($simpan){
                echo "<script>alert('Berhasil Memperbarui!!');document.location='operator-tampil'</script>";
                }else{
                echo "<script>alert('Gagal Mendaftar! Hilangkan Tanda Petik Pada Nama Pasien!');document.location='operator-edit'</script>";
                  }
                }
              }
            ?>
