    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
  		...
  		<div class="row">
  			<div class="col-lg-6">
          	<form method="post" action="user-edit-proses.php?id_user=<?php echo $data['id_user']; ?>" role="form" 
...
if (isset($_POST['edit'])){
	...
	$edit=mysqli_query($koneksi,"update user set nama='$nama',id_finger='$id_finger' where id_user='$id_user'");
	}
else{
