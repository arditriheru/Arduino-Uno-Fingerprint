...
<div class="row">
        ...
        <?php
			$no=1;
			include('../koneksi.php');
			$user=mysqli_query($koneksi,"select * from admin where level='Operator'");
		...
		<tr>
			...
			<td>
               <div>
               <a href="operator-edit.php?id_admin=<?php echo $data['id_admin']; ?>"
                <button type="button" class="btn btn-warning">EDIT</a>
               <a href="operator-hapus.php?id_admin=<?php echo $data['id_admin']; ?>"
